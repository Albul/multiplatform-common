...
[ ![Download](https://api.bintray.com/packages/olekdia/olekdia/multiplatform-common/images/download.svg?version=0.1.2) ](https://bintray.com/olekdia/olekdia/multiplatform-common/0.1.2/link)
...
dependencies {
  ...
  implementation("com.olekdia:multiplatform-common:0.1.2")
}
```
...
```gradle
dependencies {
  implementation("com.olekdia:multiplatform-common-jvm:0.1.2")
  implementation("com.olekdia:multiplatform-common-js:0.1.2")
  implementation("com.olekdia:multiplatform-common-native:0.1.2")
}
```
